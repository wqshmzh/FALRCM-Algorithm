...
f_region_information = region_level_information_GPU(f, l, S, g, sigma);
...
beta = difference;
% Objective function
J = gpuArray(zeros(max_iter, 1));
% 5x5 membership degrees local area
U_cluster1_local_5x5 = gpuArray(zeros(5, 5, max_iter)); % cluster_1
U_cluster2_local_5x5 = gpuArray(zeros(5, 5, max_iter)); % cluster_2
% Process U
U_col_sum = sum(U, 2);
U = U ./ U_col_sum;
half_d = floor(d  / 2);
